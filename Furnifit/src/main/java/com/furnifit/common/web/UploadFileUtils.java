...
public class UploadFileUtils {
	...
	private static String makeThumnail(String uploadPath, String path, String fileName) throws Exception {
		BufferedImage sourchImg=ImageIO.read(new File(uploadPath + path, fileName));
		BufferedImage destImg = Scalr.resize(sourchImg, Scalr.Method.AUTOMATIC, Scalr.Mode.FIT_TO_HEIGHT, 100);
